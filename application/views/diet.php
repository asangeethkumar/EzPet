...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href='<?php echo base_url()."users/pharamacyservices"; ?>'>Food and Pharmacy </a></li>
    <li class="breadcrumb-item active" aria-current="page">Prescription diet</li>
  </ol>
</nav>
<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form"  action="" method="post" >
						<h1 align="center" >PESCRIPTION DIET</h1>
						<br>
						<br>
						...
						<div class="wrap-input100 validate-input" data-validate = "valid name is required">
								<input type="text" name="first_name"  class="input100" placeholder="CARE TAKER  NAME"   title="digits and special characters are not allowed" value="<?php echo !empty($user['first_name'])?$user['first_name']:''; ?>" >
						...
						<div class="wrap-input100 validate-input" data-validate = "Valid email is required: emailId@abc.com">
								<input type="email"   class="input100" name="email" value="<?php echo !empty($user['email'])?$user['email']:''; ?>"placeholder="EMAIL"	 placeholder="EMAIL" >
						...
						<div class="wrap-input100 validate-input" data-validate = "  valid name  is required">
								...
								<input type="text" name="petname"   class="input100"  placeholder="PET NAME" value="<?php echo !empty($user['petname'])?$user['petname']:''; ?>"  >	
