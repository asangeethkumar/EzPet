...
<html lang="en">  
<head>
<title>diaper training pads</title>
	<meta charset="UTF-8">
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href='<?php echo base_url()."users/petmerchandise"; ?>'>Pet Marchandise </a></li>
    <li class="breadcrumb-item active" aria-current="page">Diaper training pads</li>
  </ol>
</nav>
<div class="limiter">
<div class="limiter">
