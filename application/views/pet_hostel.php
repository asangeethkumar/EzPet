...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Pet Hostel</li>
  </ol>
</nav>
<div class="limiter">
<div class="limiter">
...
<h3>OWNER INFORMATION</h3>
			...
			<div class="form-group">
				Date of joining:<br><input type="date" name="date_j"  >

			</div>
				
			<div class="form-group">
				Date of Leaving:<input type="date" name="date_l"   >
