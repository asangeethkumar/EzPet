...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">dog playground</li>
  </ol>
</nav>
<div class="limiter">
...
<div class="limiter">
		...
		<div class="container-login100">
			<div class="wrap-login100">
						...
						<h1 align="center" >DOG PLAYGROUND </h1>
						<br>
						<br>
					...
					<div class="wrap-input100 validate-input" data-validate = "valid name is required">
								...
								<span class="symbol-input100">
									...
									<div class="wrap-input100 validate-input" data-validate = "valid playground area is required">
								<input type="text" name="area"  class="input100" placeholder="PLAYGROUND AREA" value="<?php echo !empty($user['area'])?$user['area']:''; ?>" >
