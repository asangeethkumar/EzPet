			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form"  action="" method="post" >
						...
						<div class="wrap-input100 validate-input" data-validate = "  valid name  is required">
								...
								<input type="text" name="petname"   class="input100"  title="digits  and special characters are not allowed"  maxlength="32"placeholder="ENTER PET NAME" value="<?php echo !empty($user['petname'])?$user['petname']:''; ?>" >
