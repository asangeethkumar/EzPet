...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Global pet travel</li>
  </ol>
</nav>
<div class="limiter">
<div class="limiter">
		...
		<div class="container-login100">
			...
			<h4>TRAVELING INFORMATION</h4>

			<br>


								<div class="wrap-input100 validate-input" data-validate = "Valid passport id is required">
								<input type="text" name="passport"  class="input100" placeholder="PASSPORT ID" pattern="[1-9]{1}[0-9]{15}" title="Enter valid 16 digit number">
				...
				<textarea id="address" name="location" class="input100" rows="4" cols="50">
				</textarea>
				<span class="focus-input100"></span>
								<span class="symbol-input100">
			...
			<label for="address">Destination:</label>
				...
				<textarea id="address" name="dest" class="input100" rows="4" cols="50">
				</textarea>
				<span class="focus-input100"></span>
								<span class="symbol-input100">
